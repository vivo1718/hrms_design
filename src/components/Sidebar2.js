...
import { faServer, faUsersLine, faBuilding, faClipboardUser, faArrowRightToBracket, faPeopleRoof, faPersonWalking, faGears, faUserNurse, faUserFriends, faQuestion, faToolbox } from '@fortawesome/free-solid-svg-icons';
import './Sidebar2.css';
