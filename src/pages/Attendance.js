              ...
              attendanceHistory.map((record, index) => (
                <Col key={index} xs={12} sm={6} md={6} lg={4}>
                  <Card className=" col_out mb-3">
                    <Card.Body>
                      <Card.Title className="fontf">{record.name}</Card.Title>
                      <hr style={{backgroundColor:'#000'}}/>
                      <Card.Text className="fontf1"><strong>email:</strong> {record.email}</Card.Text>
                      <Card.Text className="fontf1"><strong>Department:</strong> {record.department || "N/A"}</Card.Text>
                       <Card.Text className="fontf1"><strong>Position:</strong> {record.position}</Card.Text>
