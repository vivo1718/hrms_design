...
const Payroll = () => {
  ...
  const handleInputChange = (field, value) => {
    const updatedEmployee = { ...selectedEmployee, [field]: parseFloat(value) || 0 };
  ...
  const savePayroll = async () => {
    ...
    try {
      ...
      const employeeDoc = doc(db, "users", userId, "employees", selectedEmployee.id);
  ...
  const tableData = [
    { item: "Base Salary", quantity: 1, price: `$${employee.baseSalary.toFixed(2)}`, amount: `$${employee.baseSalary.toFixed(2)}` },
    { item: "Bonus", quantity: 1, price: `$${employee.bonus.toFixed(2)}`, amount: `$${employee.bonus.toFixed(2)}` },
    { item: "Deductions", quantity: 1, price: `-$${employee.deductions.toFixed(2)}`, amount: `-$${employee.deductions.toFixed(2)}` },
  ];
  ...
  tableData.forEach((row) => {
    ...
    doc.text(row.quantity.toString(), startX + 70, currentY + 7, { align: "center" });
  ...
  doc.text(`$${employee.netPay.toFixed(2)}`, startX + 170, currentY + 7, { align: "right" });
  ...
  return (
    <div className="payrol" style={{ padding: "20px", fontFamily: '"Poppins", sans-serif',height:'100vh' }}>
    ...
    <Table striped bordered hover className="mb-0">
      ...
      <tbody>
        {payrollData.map((employee) => (
          <tr key={employee.id}>
            ...
            <td>
              <div className="d-flex flex-row justify-content-space-between align-self-stretch "
              style={{
                columnGap:"10px"
              }}
              >
      ...
      <Modal show={showModal} onHide={() => setShowModal(false)}>
        ...
        <Modal.Footer>
          ...
          <Button onClick={savePayroll} variant="success">Save Changes</Button>
        </Modal.Footer>
      </Modal>
